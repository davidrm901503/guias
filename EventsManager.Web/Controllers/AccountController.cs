...
using EventsManager.Web.Models.ViewModels;
...
namespace EventsManager.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            ViewBag.SigninModel = new LoginViewModel();
            ViewBag.SignupModel = new RegisterViewModel();
            return View();
        }
